...
export default function ChatContent({ groupId }) {
    ...
    function handleAddMessage() {
        try {
            return createUserMessage(groupMessageRef, userMessage.current.value);
        } catch (err) {
            console.log(err)
        } finally {
    ...
    return (
        <div className='chat-content-container'>
            <div className='scrollable-container'>
                ...
                <div className='chat-content reciever'>
                    <span className='profile'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                    ...
                    <p className='message'>
                        Hii <br />
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi adipisci exercitationem distinctio officiis? Minus obcaecati nobis omnis quas voluptate est, id voluptas quis, consequatur, totam laboriosam. Debitis voluptatem quia a?
                        <br />
                        <br />
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic unde delectus nam laudantium possimus consequuntur saepe in, commodi deleniti, culpa consectetur natus optio maxime sit, est velit quis tenetur quas.
                    </p>
                </div>*/}
            </div>
            ...
            <div className='input-message-container'>
                ...
                <textarea className='message-box' name="message" ref={userMessage}></textarea>
                ...
                <button className='btn-send' onClick={handleAddMessage}>
                    Send
