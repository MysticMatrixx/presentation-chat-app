...
export function ChatPage() {
    ...
    useEffect(() => {
        console.log('ID CHANGED to ' + groupId)
    }, [groupId])
    ...
    return (
        <div className='chat-container'>
            ...
            {groupId && <button className='btn-settings' onClick={changeNav}>
            ...
            {groupId && <ChatContent groupId={groupId} />}
            {groupId && <ChatSettings groupId={groupId} />}
        </div>
    )
}
